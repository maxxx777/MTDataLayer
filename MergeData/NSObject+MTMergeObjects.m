...
@implementation NSObject (MTMergeObjects)
                  ...
                  error: (NSError * __autoreleasing *)error
{
    ...
    @finally {
        ...
        if (!success) {
            if (error) {
                *error = [NSError errorWithDomain:MTDataStoreErrorDomain
                                             code:MTDataStoreErrorTypeMergeObjects
                                         userInfo:nil];
            }
        }
